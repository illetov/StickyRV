...
public class StickDecor extends RecyclerView.ItemDecoration {

    private StickyHeaderInterface mListener;
    private int mStickyHeaderHeight;

    public StickDecor(@NonNull StickyHeaderInterface listener) {
        mListener = listener;
    }
    ...
    public interface StickyHeaderInterface {
        ...
        /**
         * This method gets called by {@link } to fetch the position of the header item in the adapter
        ...
        /**
         * This method gets called by {@link } to get layout resource id for the header item at specified adapter's position.
        ...
        /**
         * This method gets called by {@link } to setup the header View.
        ...
        /**
         * This method gets called by {@link } to verify whether the item represents a header.
